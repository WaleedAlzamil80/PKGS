...
# ggv = pd.read_csv(r"/home/waleed/catkin_ws/src/global_planning/scripts/global_racetrajectory_optimization-master/inputs/veh_dyn_info/ggv.csv")
# ggv = np.array(ggv).reshape(-1,3)
# print(ggv.shape)
# ggv = pd.read_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'inputs', 'veh_dyn_info', 'ggv.csv'))
# print(ggv)
# ggv = np.array(ggv).reshape(-1,3)
# print(ggv.shape)
...
# I need to know what exactly these files are.
# ----------------------------------------------------------------------------------------------------------------------
...
# this line of code replaces the ubove conditions as we want to use min_curv
pars["optim_opts"] = json.loads(parser.get('OPTIMIZATION_OPTIONS', 'optim_opts_mincurv'))
...
ggv = np.array(pd.read_csv(os.path.join(file_paths["module"], 'inputs', 'veh_dyn_info', 'ggv.csv'))).reshape(-1,3)
ax_max_machines = np.array(pd.read_csv(os.path.join(file_paths["module"], 'inputs', 'veh_dyn_info', 'ax_max_machines.csv'))).reshape(-1,2)
