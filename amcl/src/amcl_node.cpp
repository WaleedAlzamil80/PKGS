        ...
        first_reconfigure_call_(true)
{
  ...
  laser_check_interval_ = ros::Duration(25.0); //CHANGES MARIAM
...
void AmclNode::runFromBag(const std::string &in_bag_fn, bool trigger_global_localization)
{
  ...
  std::string scan_topic_name = "/scan"; // TODO determine what topic this actually is from ROS CHANGES MARIAM base_scan to /scan
